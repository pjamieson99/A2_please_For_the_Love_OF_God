...
Public Class Form1
    ...
    Public Sub WriteCreature(Animal As CCreature, GenNum As Integer, NumberOfLegs As Integer, NumberOfLayers As Integer, Creature_ID As Integer)
        ...
        'Connection.Open()
        QueryDatabase("INSERT INTO Body([BPY1], [BPY2], [BPX1], [BPX2], [NumOfLegs]) VALUES (" & Animal.Body.BPy1 & "," & Animal.Body.BPy2 & "," & Animal.Body.BPx1 & "," & Animal.Body.BPx2 & "," & NumberOfLegs & ")", True)
        ...
        For y = 0 To NumberOfLayers - 1
            For x = 0 To NumberOfLegs - 1
