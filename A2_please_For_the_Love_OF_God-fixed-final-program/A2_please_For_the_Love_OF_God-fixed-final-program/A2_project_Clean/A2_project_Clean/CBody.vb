Public Class CBody
    ...
    Public LeftMomentum As Double = 0.3 'this is the momentum at which the body falls in a direction
    Public RightMomentum As Double = 0.3
    ...
    Sub FallRight(Pivot As PointF, g As Graphics) 'if body is falling right it uses this function
        AngleIncrease = RightMomentum 'updates how fast the body is falling
        RightMomentum -= 0.3
    ...
    Sub FallLeft(Pivot As PointF, G As Graphics) 'if body is falling left it uses this function
        AngleIncrease = LeftMomentum 'updates how fast the body is falling
        LeftMomentum += 0.3
