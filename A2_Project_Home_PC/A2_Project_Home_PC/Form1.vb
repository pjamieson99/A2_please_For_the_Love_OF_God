Public Class Form1
    ...
    Private Sub Display_Paint(sender As Object, e As PaintEventArgs) Handles Display.Paint
        ...
        For x = 0 To NumOfAnimals - 1
            If FurthestAnimalPos < Animal(x).Body.CoM.X And Animal(x).Body.CoM.X > 500 Then
                '     FurthestAnimalPos = Animal(x).Body.CoM.X - 500
            End If
        Next
